...
class FileSystem
{
	 ...
	 * @see ensure_file
	 */
	public static function ensure_file($name, array $params)
	{
		$defaults = [
			"ensure"   => null,
			"path"     => null,
	...
	/**
	 * @see ensure_file_line
	 */
	public static function ensure_file_line($name, array $params) {
	...
	/**
	 * @see ensure_directory
	 */
	public static function ensure_directory($name, array $params) {
